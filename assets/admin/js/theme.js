...
const swal = Swal.mixin({
    customClass: {
        confirmButton: 'h1 btn btn-sm  btn-primary m-2',
        cancelButton: 'btn btn-sm h1 btn-secondary m-2',
        denyButton: 'btn btn-sm h1 btn-danger m-2'
    },
    buttonsStyling: false,
    showClass: {
        popup: 'animated fadeIn' //flipInX'
    },
    hideClass: {
        popup: 'animated fadeOut //flipOutX'
    }
})
...
$(document).on('click', '[data-toggle-custom-template]', function(){
    $('.custom-template').toggleClass('open').focus()
})


function imprSelec(nombre, title) {
    /*var ficha = document.getElementById(nombre).href = base_url + 'assets/admin/dist/secore.min.css';
