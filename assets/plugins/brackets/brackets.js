            ...
            if( titles ){
                if ( Array.isArray(titles) ){
                    ...
                    $.each( titles, function(i, title){
                        html_titles += '<div class="title bg-primary text-white text-uppercase">' + title + '</div>';
                    });

                }else{

                    for(i = 1; i <= max_brackets; i++){
                        if( i == max_brackets) html_titles += '<div class="title bg-primary text-white text-uppercase">Champion</div>';
                        else if( i == (max_brackets-1) && max_brackets > 2 ) html_titles += '<div class="title bg-primary text-white text-uppercase">Final</div>';
                        else if( i == (max_brackets-2) && max_brackets > 3 ) html_titles += '<div class="title bg-primary text-white text-uppercase">Semifinal</div>';
                        else html_titles += '<div class="title bg-primary text-white text-uppercase">Round ' + i + '</div>';
                    }
                }
