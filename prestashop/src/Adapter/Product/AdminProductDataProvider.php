...
class AdminProductDataProvider extends AbstractAdminQueryBuilder implements ProductInterface
{
    ...
    public function getCatalogProductList(
        ...
        $sqlSelect = [
            ...
            'wholesale_price' => ['table' => 'p', 'field' => 'wholesale_price', 'filtering' => ' %s '],
            'isbn' => ['table' => 'p', 'field' => 'isbn', 'filtering' => ' %s '],
            'ean13' => ['table' => 'p', 'field' => 'ean13', 'filtering' => ' %s '],
            'upc' => ['table' => 'p', 'field' => 'upc', 'filtering' => ' %s '],
            'mpn' => ['table' => 'p', 'field' => 'mpn', 'filtering' => ' %s '],
        ];
        $sqlTable = [
            'p' => 'product',
            'pl' => [
