...
final class ProductCsvExporter implements ProductExporterInterface
{
    ...
    public function export(array $products = [])
    {
        ...
        $headersData = [
            ...
            'wholesale_price' => $this->trans('Coste', 'Admin.Catalog.Feature'),
            ...
            'isbn' => $this->trans('ISBN', 'Admin.Catalog.Feature'),
            'ean13' => $this->trans('EAN13', 'Admin.Catalog.Feature'),
            'upc' => $this->trans('UPC', 'Admin.Catalog.Feature'),
            'mpn' => $this->trans('MPN', 'Admin.Catalog.Feature'),
        ];
