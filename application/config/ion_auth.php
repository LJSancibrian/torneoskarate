 ...
 */
$config['site_title']                 = base_url();          // Site Title, example.com
$config['admin_email']                = "tiobavie@hotmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'usuario';           // Default group, use name
$config['admin_group']                = 'webmaster';             // Default administrators group, use name
...
$config['lockout_time']               = 3000;                 /* The number of seconds to lockout an account due to exceeded attempts
...
/*
 ...
 | Please customize
 */
$config['session_hash'] = 'snankswpprkctnizlhehkkvnyclrymxgewijpzwwzffvbbsoswcoelzvjnqneyimiqfaawqngzgjnugmuosiokvdgjdjcpcbamin';
 ...
 */
$config['remember_cookie_name'] = 'remember_login';
...
$config['error_start_delimiter']   = '<spam>';		// Error message start delimiter
$config['error_end_delimiter']     = '</spam>';	// Error message end delimiter
