                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                                <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:25px;line-height:1;text-align:left;color:#008081;">Sistema de recuperación de contraseña<br /><br /><span style="color:#008081; font-size:20px">Hola, <?php echo $nombre;?></span></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                                <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:left;color:#008081;">Se ha iniciado el sistema de recuparación de contraseña en la web karatepielagos.com.<br /><br />Para crear una nueva contraseña pulsa el botón "Crear nueva contraseña".<br /><br />El botón es un enlace que abrirá la página web de creación de nueva contraseña. Es un enlace de un solo uso y es válido durante media hora. Pasado este tiempo deberás iniciar de nuevo el proceso</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" vertical-align="middle" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                    <tr>
                                                        <td align="center" bgcolor="#008081" role="presentation" style="border:none;border-radius:50px;cursor:auto;mso-padding-alt:10px 25px;background:#008081;" valign="middle">
                                                            <p style="display:inline-block;background:#008081;color:#ffffff;font-family:open Sans Helvetica, Arial, sans-serif;font-size:20px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:50px;">
                                                                <a href="<?php echo $link;?>" style="color:#ffffff; text-decoration: none;">Crear nueva contraseña</a>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </table>
