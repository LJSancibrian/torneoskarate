                ...
                <tbody>
                    ...
                    foreach ($clasificacion as $key => $finalista) { ?>
                        <tr>
                            ...
                            <td><?php echo $finalista->ganados;?></td>
                            <td><?php echo $finalista->puntos;?></td>
                            <td><?php echo $finalista->puntos_contra;?></td>
                            <td><?php echo $finalista->senshu;?></td>
                            <td><?php echo $finalista->hantei;?></td>
                        </tr>
                    <?php  $pos++; } ?>
                </tbody>
            </table>
